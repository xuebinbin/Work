...

{
...

    {
        ...
        public SerialPortCtr(string comPortName)
        ...
        public SerialPortCtr(string comPortName, int baudRate, Parity parity, int dataBits, StopBits stopBits)
