...
namespace HotelZzKp
{
    ...
    public class SPMX
    {
        public string DJ { get; set; }// 单价
        public string GGXH { get; set; }//规格型号
        public string HWMC { get; set; }//货物名称
        public string HWSL { get; set; }//数量
        public string JE { get; set; }//金额
        public string JLDW { get; set; }//单位
